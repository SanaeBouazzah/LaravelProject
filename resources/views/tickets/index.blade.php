  ...
  <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
      <div class="flex justify-between w-full sm:max-w-xl">
          ...
          <div class="flex items-center justify-end mt-4">
            <a href="{{ route('tickets.create') }}" class="bg-gray-800 dark:bg-gray-200 text-white
             inline-flex items-center px-4 py-2 border border-transparent rounded-md font-semibold">Create New</a>
        </div>
      </div>
